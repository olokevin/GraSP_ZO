...
# CUDA_VISIBLE_DEVICES=2 python -u tensor_train.py -tensorized 1 -uncompressed 0 -precondition 0 -save_model model/${file} -save_mode best -proj_share_weight -label_smoothing -batch_size 32 -epoch 500 -config configs/ATIS/GraSP_90.yml|tee logs/${file}.txt
...
CUDA_VISIBLE_DEVICES=2 python -u main_prune_MNIST.py -config configs/MNIST/FC/SCD.yml